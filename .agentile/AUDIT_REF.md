...
# Active audit reference — `citrate-agent-runtime`
...
- This repo's folder: `.../per-repo/citrate-agent-runtime/` — `MAP.md` (architecture + data-flow +
...
- Phase-1 mapping complete; see `per-repo/citrate-agent-runtime/MAP.md` for the mapped surface and
